  ...
  template: `
    <div class="container">
      <div class="header">
        ...
        <p>Consulter et gérer la liste des bénéficiaires</p>
      </div>
      <button class="btn-new">+ Ajouter un bénéficiaire</button>

      <div class="card">
        <h3>Aucun bénéficiaire trouvé</h3>
        <p>Il n'y a pas encore de bénéficiaires enregistrés.</p>
      </div>
    </div>
  `,
  styles: [`
